                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-2 overflow-x-auto">
                            ...
                            <div class="flex-auto p-6">
                                <p class="text-sm leading-normal uppercase">Edit Extracurricular</p>
                                <form method="POST"
                                    action="{{ route('admin.extracurricular.update', $extracurricular->slug) }}"
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="description"
                                                    value="{{ $extracurricular->description }}" required autofocus
                                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-70 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="description"
                                                    class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700">Coach</label>
                                                <input type="text" name="coach" value="{{ $extracurricular->coach }}"
                                                    required autofocus
                                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-70 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="description"
                                                    class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700">Jadwal</label>
                                                <input type="text" name="jadwal" value="{{ $extracurricular->jadwal }}"
                                                    required autofocus
                                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-70 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <div class="items-center gap-10">
                                                    <img src="{{ Storage::url($extracurricular->thumbnail2) }}"
                                                        alt="thumbnail2"
                                                        class="rounded-2xl object-cover w-[160px] h-[90px] mb-2">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <div class="items-center gap-10">
                                                    <img src="{{ Storage::url($extracurricular->thumbnail3) }}"
                                                        alt="thumbnail3"
                                                        class="rounded-2xl object-cover w-[160px] h-[90px] mb-2">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <div class="items-center gap-10">
                                                    <img src="{{ Storage::url($extracurricular->thumbnail4) }}"
                                                        alt="thumbnail"
                                                        class="rounded-2xl object-cover w-[160px] h-[90px] mb-2">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <div class="items-center gap-10">
                                                    <img src="{{ Storage::url($extracurricular->thumbnail5) }}"
                                                        alt="thumbnail"
                                                        class="rounded-2xl object-cover w-[160px] h-[90px] mb-2">
