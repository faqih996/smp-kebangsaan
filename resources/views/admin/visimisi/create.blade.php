                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-2 overflow-x-auto">
                            ...
                            <div class="flex-auto p-6">
                                <p class="text-sm leading-normal uppercase">Visi & Misi Sekolah</p>
                                <form method="POST" action="{{ route('admin.vision-mission.store') }}"
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                                            <div class="mb-4">
                                                <label for="name"
                                                    class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700">Visi</label>
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                                            <div class="flex flex-col py-2 mb-4">
                                                ...
                                                <input type="text" name="mission[]" required autofocus
                                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-70 focus:outline-none" />
                                                <div class="flex flex-col" id="newMissionRow"></div>
                                            </div>
                                            <button type="button"
